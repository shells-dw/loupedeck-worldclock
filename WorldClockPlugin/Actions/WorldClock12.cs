namespace Loupedeck.WorldClockPlugin
{
    ...
    public class WorldClock12 : PluginDynamicCommand
    {
        ...
        protected override Boolean OnLoad()
        {
            ...
            this.l7dValues = this._l10n.GetL7dNames("time12");
            ...
            {
                this.DisplayName = "Time (12h Format)";
                this.GroupName = "Time";
                this._plugin.Log.Info($"12h : l7dValues was empty or null: DisplayName: {this.l7dValues["displayName"]}, groupName: {this.l7dValues["groupName"]}.");
            }

namespace Loupedeck.WorldClockPlugin
{
    ...
    public class WorldClockSeconds24 : PluginDynamicCommand
    {
        private WorldClockPlugin _plugin;
        public WorldClockSeconds24()
            : base(displayName: "Time + Seconds (24h Format)", description: "Shows time in 24h format", groupName: "Time") => this.MakeProfileAction("tree");

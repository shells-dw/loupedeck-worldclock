namespace Loupedeck.WorldClockPlugin
{
    ...
    public class WorldClock12DL : PluginDynamicCommand
    {
        ...
        protected override Boolean OnLoad()
        {
            ...
            this.l7dValues = this._l10n.GetL7dNames("time12DL");
            ...
            {
                this.DisplayName = "Time + Date + Location (12h Format)";
                this.GroupName = "Digital";
                this._plugin.Log.Info($"12hDL : l7dValues was empty or null: DisplayName: {this.l7dValues["displayName"]}, groupName: {this.l7dValues["groupName"]}.");
            }

namespace Loupedeck.WorldClockPlugin
{
    ...
    public class WorldClock24SL : PluginDynamicCommand
    {
        private WorldClockPlugin _plugin;
        public WorldClock24SL()
            : base(displayName: "Time + Location + Seconds (24h Format)", description: "Shows time in 24h format", groupName: "Time") => this.MakeProfileAction("tree");

namespace Loupedeck.WorldClockPlugin
{
    ...
    public class WorldDay : PluginDynamicCommand
    {
        ...
        protected override Boolean OnLoad()
        {
            ...
            this.l7dValues = this._l10n.GetL7dNames("dayinyear");
            if (this.l7dValues != null)
            {
                this.AddParameter("dayinyear", this.l7dValues["displayName"], "");
            }
            else
            {
                this.AddParameter("dayinyear", "Day in Year", "Digital");
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
            ...
            using (var bitmapBuilder = new BitmapBuilder(imageSize))
            {
                ...
                if (!String.IsNullOrEmpty(actionParameter))
                {
                    ...
                    bitmapBuilder.DrawText(today.DayOfYear.ToString(), (Int32)x1, (Int32)y1, (Int32)w, (Int32)h, BitmapColor.White, imageSize == PluginImageSize.Width90 ? 40 : 9, imageSize == PluginImageSize.Width90 ? 12 : 5);

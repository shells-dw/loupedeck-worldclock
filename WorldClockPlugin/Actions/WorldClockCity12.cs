namespace Loupedeck.WorldClockPlugin
{
    ...
    public class WorldClockCity12 : PluginDynamicCommand
    {
        private WorldClockPlugin _plugin;
        public WorldClockCity12()
            : base(displayName: "Time + Location (12h Format)", description: "Shows time in 12h format", groupName: "Time") => this.MakeProfileAction("tree");

namespace Loupedeck.WorldClockPlugin
{
    ...
    public class WorldClock24DWN : PluginDynamicCommand
    {
        ...
        protected override Boolean OnLoad()
        {
            ...
            this.l7dValues = this._l10n.GetL7dNames("time24DWN");
            ...
            {
                this.DisplayName = "Time + Date + Weekday Name (24h Format)";
        ...
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
            ...
            using (var bitmapBuilder = new BitmapBuilder(imageSize))
            {
                ...
                if (!String.IsNullOrEmpty(actionParameter))
                {
                    ...
                    var y3 = bitmapBuilder.Height * 0.62;

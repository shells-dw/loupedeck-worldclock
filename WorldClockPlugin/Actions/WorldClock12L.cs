namespace Loupedeck.WorldClockPlugin
{
    ...
    public class WorldClock12L : PluginDynamicCommand
    {
        ...
        protected override Boolean OnLoad()
        {
            ...
            this.l7dValues = this._l10n.GetL7dNames("time12L");
            ...
            {
                this.DisplayName = "Time + Location (12h Format)";
